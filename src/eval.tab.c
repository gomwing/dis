...
#   if ! defined malloc && ! defined _STDLIB_H && (defined __STDC__ || defined __C99__FUNC__ \
     || defined __cplusplus || defined _MSC_VER)
////void *malloc (YYSIZE_T); /* INFRINGES ON USER NAME SPACE */ GOMWING
#   endif
#  endif
#  ifndef YYFREE
#   define YYFREE free
#   if ! defined free && ! defined _STDLIB_H && (defined __STDC__ || defined __C99__FUNC__ \
     || defined __cplusplus || defined _MSC_VER)
////void free (void *); /* INFRINGES ON USER NAME SPACE */ GOMWING
#   endif
#  endif
# endif
...
static const yytype_uint8 yyrline[] =
{
     ...
     126,   127,   130,   131,   132,   135,   136,   137,   138,   139,
     142,   143,   144,   147,   148,   149,   150,   153,   154,   155,
...
static const char *const yytname[] =
{
  ...
  "relational_expr", "additive_expr", "mul_expr", "factor", "element", 0
};
#endif
...
#line 153 "eval.y"
    /*{ (yyval.val) = - (yyvsp[(2) - (2)].val); ;}*/
  { (yyval.val) = (yyvsp[(2) - (2)].val); ; }   //GOMWING
    break;
...
tabledesc (int num, opesize id)
{
	...
	case PARSE_ANALYZING:
		...
		free (ExpStack[i]->bufptr);	/* release string buffer */
		free (ExpStack[i]);
		break;
...
store (expbuf* exp)
{
	...
	err ("Expression evaluation stack overflowed\n");
...
{
	if ((UINTPTR)adrs & 1)
	eprintf ("Warning: peek.The argument of %c is an odd address (%x)\n", size, adrs);
}
